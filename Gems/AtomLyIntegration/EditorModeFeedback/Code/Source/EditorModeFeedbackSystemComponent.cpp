...
namespace AZ
{
    namespace Render
    {
        ...
        //    EntityId entityId, const MeshFeatureProcessorInterface::MeshHandle& meshHandle)
        //{
        //    // Overwrite any existing mesh handle for this component-entity id
        //    auto& meshHandleDrawPackets = m_entityMeshHandleDrawPackets[entityId];
            ...
            AzToolsFramework::ViewportEditorMode mode)
        {
            ...
            {
                //for (auto& [entityId, meshHandleDrawPackets] : m_entityMeshHandleDrawPackets)
                //{
                //    meshHandleDrawPackets.m_meshDrawPackets.clear();
                //}
        ...
        void EditorModeFeedbackSystemComponent::OnTick([[maybe_unused]] float deltaTime, [[maybe_unused]] AZ::ScriptTimePoint time)
        {
            ...
            //{
            //    const auto entityMeshHandleDrawPacketsIterator = m_entityMeshHandleDrawPackets.find(focusedEntityId);
            //    if (entityMeshHandleDrawPacketsIterator == m_entityMeshHandleDrawPackets.end())
            //    {
            //        // No drawable data for this entity
            //        continue;
            //    }
            //
            //    auto& meshHandleDrawPackets = entityMeshHandleDrawPacketsIterator->second;
            //    
            //    const auto scene = RPI::Scene::GetSceneForEntityId(entityMeshHandleDrawPacketsIterator->first);
