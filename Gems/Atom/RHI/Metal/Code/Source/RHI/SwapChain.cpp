...
namespace AZ
{
    namespace Metal
    {
        ...
        uint32_t SwapChain::PresentInternal()
        {
            ...
            //Preset the drawable
            Platform::PresentInternal(m_mtlCommandBuffer, m_drawables[currentImageIndex], GetDescriptor().m_verticalSyncInterval, Base::GetDevice().GetMainDisplayRefreshRate());
