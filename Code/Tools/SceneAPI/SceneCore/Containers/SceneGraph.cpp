...
namespace AZ
{
    namespace SceneAPI
    {
        namespace Containers
        {
            ...
            // SceneGraph
            //
            AZStd::shared_ptr<const DataTypes::IGraphObject> SceneGraph::ConstDataConverter(
                const AZStd::shared_ptr<DataTypes::IGraphObject>& value)
            {
            ...
            {
                return NodeIndex(
                    node.m_parentIndex != NodeHeader::INVALID_INDEX ? static_cast<uint32_t>(node.m_parentIndex) : NodeIndex::INVALID_INDEX);
            }
            ...
            {
                return NodeIndex(
                    node.m_siblingIndex != NodeHeader::INVALID_INDEX ? static_cast<uint32_t>(node.m_siblingIndex)
            ...
            {
                return NodeIndex(
                    node.m_childIndex != NodeHeader::INVALID_INDEX ? static_cast<uint32_t>(node.m_childIndex) : NodeIndex::INVALID_INDEX);
            }
            ...
            {
                return node.m_value < m_content.size() ? Views::MakeConvertIterator(m_content.cbegin() + node.m_value, ConstDataConverter)
            ...
            {
                return NodeIndex(
                    iterator != m_hierarchy.cend() ? static_cast<uint32_t>(std::distance(m_hierarchy.cbegin(), iterator))
                                                   : NodeIndex::INVALID_INDEX);
            }
            ...
            {
                return NodeIndex(
                    iterator != m_names.cend() ? static_cast<uint32_t>(std::distance(m_names.cbegin(), iterator))
                                               : NodeIndex::INVALID_INDEX);
            }
            ...
            {
                return NodeIndex(
                    iterator != m_content.end() ? static_cast<uint32_t>(std::distance(m_content.begin(), iterator))
                                                : NodeIndex::INVALID_INDEX);
            }
