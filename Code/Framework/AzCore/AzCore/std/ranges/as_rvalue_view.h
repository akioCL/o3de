...
namespace AZStd::ranges::views
{
    namespace Internal
    {
        ...
        constexpr bool is_rvalue_reference_same_as_reference_t = false;
        template<class View>
        constexpr bool is_rvalue_reference_same_as_reference_t <View, enable_if_t<
            same_as<range_rvalue_reference_t<AZStd::remove_cvref_t<View>>, range_reference_t<AZStd::remove_cvref_t<View>>>
        >> = true;
            ...
            : Internal::range_adaptor_closure<as_rvalue_fn>
        {
            ...
            {
                if constexpr(is_rvalue_reference_same_as_reference_t<View>)
                {
