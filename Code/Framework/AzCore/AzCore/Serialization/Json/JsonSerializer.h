...
namespace AZ
{
    ...
    private:
        ...
        static JsonSerializationResult::ResultCode StoreWithClassData(rapidjson::Value& node, const void* object, const void* defaultObject,
            const Serialization::ClassData& classData, StoreTypeId storeTypeId, JsonSerializerContext& context);

        static JsonSerializationResult::ResultCode StoreWithClassDataFromPointer(rapidjson::Value& output, const void* object,
            const void* defaultObject, const Serialization::ClassData& classData, JsonSerializerContext& context);
        ...
        static ResolvePointerResult ResolvePointer(JsonSerializationResult::ResultCode& status, StoreTypeId& storeTypeId,
            ...
            const Serialization::ClassData*& elementClassData, const AZ::IRttiHelper& rtti,  JsonSerializerContext& context);

        static rapidjson::Value StoreTypeName(const Serialization::ClassData& classData, JsonSerializerContext& context);
