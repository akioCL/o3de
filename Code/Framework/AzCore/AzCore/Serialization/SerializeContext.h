...
namespace AZ
{
    ...
    public:
        ...
        */
        ...
        struct ClassElement
        {
            ...
            AZStd::vector<AttributeSharedPair> m_attributes; ///< Attributes attached to ClassElement.
        ...
        public:
            ...
            ///< Attributes for this class type.
            AZStd::vector<AttributeSharedPair> m_attributes;
        };
    ...
    public:
        class ClassBuilder
        {
            ...
            AZStd::vector<AttributeSharedPair>* m_currentAttributes = nullptr;
        public:
            ~ClassBuilder();
    ...
    */
    ...
    {
    public:
        struct GenericInfoModuleMapItem
        {
            AZ::GenericClassInfo* m_classInfo;
            AZStd::size_t m_allocationSize;
            AZStd::size_t m_allocationAlignment;
        };
        using GenericInfoModuleMap = AZStd::unordered_map<AZ::Uuid, GenericInfoModuleMapItem>;

        PerModuleGenericClassInfo();
        ~PerModuleGenericClassInfo();

        void AddGenericClassInfo(AZ::GenericClassInfo* genericClassInfo, AZStd::size_t allocationSize, AZStd::size_t allocationAlignment);
    ...
    AttributePtr CreateModuleAttribute(T&& attrValue)
    {
        void* rawMemory = AZ::AllocatorInstance<AZ::SystemAllocator>::Get().allocate(sizeof(ContainerType), alignof(ContainerType));
        new (rawMemory) ContainerType{ AZStd::forward<T>(attrValue) };
        auto attributeDeleter = [](Attribute* attribute)
        {
            attribute->~Attribute();
            AZ::AllocatorInstance<AZ::SystemAllocator>::Get().deallocate(attribute);
        };
