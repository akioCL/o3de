...
#define AZ_TRAIT_OS_PLATFORM_NAME "iOS"
#define AZ_TRAIT_OS_PLATFORM_CFG_NAME "ios"
#define AZ_TRAIT_OS_PLATFORM_CODENAME AZ_TRAIT_OS_PLATFORM_NAME
#define AZ_TRAIT_OS_PLATFORM_CODENAME_LOWER "ios"
...
#define AZ_TRAIT_TEST_ROOT_FOLDER (AZStd::string(getenv("HOME")) + "/Documents/")
